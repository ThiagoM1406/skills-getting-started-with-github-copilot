            ...
            ${details.participants.length
              ? `<ul>${details.participants.map((participant) => `
                  <li>
                    ...
                    <button type="button" class="delete-participant" data-activity="${name}" data-participant="${participant}" aria-label="Remove ${participant}" title="Remove participant">&#10005;</button>
                  </li>`).join("")}</ul>`
